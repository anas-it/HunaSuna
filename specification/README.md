...
| `plans/completed-plans/05-разделение-web-mobile.md` | `working-plan` | завершен | История разделения web-сайта и мобильного приложения на `Web-Project/` и `Mobile-App/`. |
